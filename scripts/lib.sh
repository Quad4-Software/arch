...
load_pkg_conf() {
	...
	*)
	...
	export KIND GITHUB TAG BRANCH SOURCE_TARBALL CONFLICTS PROVIDES REPLACES
	export ASSET_x86_64 ASSET_aarch64 ASSET_armv7h ARCHES
	export VERIFY COSIGN_PUB SLSA_PROVENANCE SLSA_SOURCE_URI
	export INCLUDE_PRERELEASE PYPI_NAME VERSION SHA256SUMS
	export APPVER TAG_FILTER VERSION_FROM VERSION_SUFFIX VERSION_SUFFIX_FROM
}
